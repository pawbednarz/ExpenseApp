...
insert into category(name, is_default_category) values ("Transport", 1);
insert into category(name, is_default_category) values ("Food", 1);
insert into category(name, is_default_category) values ("Clothes", 1);
insert into category(name, is_default_category) values ("Electronics", 1);
insert into category(name, is_default_category) values ("Games", 1);
